...
function PlaceOrder() {
  ...
  return (
    <section className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <input type="text" placeholder='Email' className='border border-gray-300 rounded py-1.5 px-3.5 w-full' />
     ...
     <div className="mt-8 min-w-80">
      ...
      <div className="w-full text-end mt-8">
        <button onClick={() => navigate('/order')} className='bg-black text-white px-8 py-3 cursor-pointer'>PLACE ORDER</button>
      </div>
     </div>
    </section>
  )
