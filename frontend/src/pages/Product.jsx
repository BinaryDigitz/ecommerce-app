    ...
    <section className='border-t-2 pt-10  transition-opacity ease-in duration-500 opacity-100'>
          ...
          <div className="flex sm:flex-col overflow-x-auto sm:overflow-y-scroll justify-between sm:justify-normal sm:w-[18.7%] w-full">
            {
              productData.image.map((item, index) =>(
                <img onClick={() => setImage(item)} src={item} key={index} className='w-[24px] sm:w-full sm:mb-3 flex-shrink-0' alt="" />
              ))
            }
          </div>
      ...
      <div className='mt-20'>
        <div className="flex">
          ...
          <p className='border px-5 py-3 cursor-pointer text-sm'>Reviews(122)</p>
        </div>
        <div className="flex flex-col gap-e border px-6 py-6 text-sm text-gray-500">
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero nemo incidunt quaerat hic ad qisci enim laudantium corporis at ea illum commodi nihillaudantium.</p>
          <p>E-commerce website typically display products or services along with detailed description, accompanied with eye catching photos</p>
        </div>
      </div>
      {/* ..............Display related products */}
      <DisplayRelatedProduct category={productData.category} subcategory={productData.subCategory} />
