...
function Add() {
  ...
  return (
    <form
      ...
      className="flex flex-col w-full items-start gap-3 p-10"
    >
      <div className="">
        ...
        <div className="flex gap-3">
            ...
            onClick={() =>
              setProduct({
                ...
                sizes: product.sizes.includes("S")
                  ? product.sizes.filter((item) => item !== "S")
                  : [...product.sizes, "S"],
              })
            }
          >
            <p
              className={`${
                product.sizes.includes("S") ? "bg-pink-200" : "bg-slate-200"
          ...
          <div
            onClick={() =>
              setProduct({
                ...product,
                sizes: product.sizes.includes("M")
                  ? product.sizes.filter((item) => item !== "M")
                  : [...product.sizes, "M"],
              })
            }
          >
            <p
              className={`${
                product.sizes.includes("M") ? "bg-pink-200" : "bg-slate-200"
              } px-3 py-1 cursor-pointer`}
            >
              M
            </p>
          ...
          <div
            onClick={() =>
              setProduct({
                ...product,
                sizes: product.sizes.includes("L")
                  ? product.sizes.filter((item) => item !== "L")
                  : [...product.sizes, "L"],
              })
            }
          >
            <p
              className={`${
                product.sizes.includes("L") ? "bg-pink-200" : "bg-slate-200"
              } px-3 py-1 cursor-pointer`}
            >
              L
            </p>
          ...
          <div
            onClick={() =>
              setProduct({
                ...product,
                sizes: product.sizes.includes("XL")
                  ? product.sizes.filter((item) => item !== "XL")
                  : [...product.sizes, "XL"],
              })
            }
          >
            <p
              className={`${
                product.sizes.includes("XL") ? "bg-pink-200" : "bg-slate-200"
              } px-3 py-1 cursor-pointer`}
            >
              XL
            </p>
          ...
          <div
            onClick={() =>
              setProduct({
                ...product,
                sizes: product.sizes.includes("XXL")
                  ? product.sizes.filter((item) => item !== "XXL")
                  : [...product.sizes, "XXL"],
              })
            }
          >
            <p
              className={`${
                product.sizes.includes("XXL") ? "bg-pink-200" : "bg-slate-200"
              } px-3 py-1 cursor-pointer`}
            >
              XXL
            </p>
      ...
      <button className="w-32 cursor-pointer hover:opacity-75 py-3 mt-4 bg-black text-white">
